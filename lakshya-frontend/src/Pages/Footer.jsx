  ...
  return (
    ...
    height={'720px'}
      ...
      <div className='ltline'>
        ...
        <h1 className='l1'>  Why Book Tuition Classes on GuruQ  </h1>
            <p className='lp'>GuruQ is India's largest tutoring platform that connects students with the right tutors. Through the GuruQ platform, students can choose between 1-on-1 tuition classes either with a home tutor or through online tuitions. GuruQ's advanced technology and search algorithms help students find the top tutors for their specific study needs, including requirements such as experience, schedule, and budget. Students can book online classes or home tuitions for completing their syllabus or resolving doubts.<br></br>

One significant advantage of personalized tuition classes is that students can study at their own pace and time, while receiving personalized attention from their chosen tutor. This enables students to study better and stay focused while saving travel time.<br></br>

GuruQ has leveraged technology to create a specialized tech-enabled platform where students and tutors can easily connect and learn together. The platform includes an integrated video conferencing feature, allowing students and tutors to chat and take online tuition classes without the need for third-party platforms. This provides a seamless learning experience. The tech platform is user-friendly, highly interactive, and a one-stop learning solution for school learning (K-12), providing offline tutors or online coaching for all school boards including CBSE, ICSE, IGCSE, IB, and State Boards. GuruQ also provides home tuitions or online tutors for competitive exams, language learning, and study abroad exams.<br></br>

Students can easily search for offline tutors in Gurgaon, top home tutors in Bangalore, tutors near me in Delhi, top school tutors in Noida, CBSE tutors in Chennai, IB tutors near me in Bangalore, and more through GuruQ.<br></br>

Students can search for language tutors by simple search as French tutor in Mumbai, Language tutor in Hyderabad or Spanish tutor in Chandigarh. GuruQ is the one stop shop for all the tuition needs of a learner.</p>
      </div>
    </Box>
  )
}